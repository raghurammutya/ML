-- Migration 016: Create Continuous Aggregates (Modified for Regular Views)
-- Date: 2025-11-02
...
-- NEW STATE: Create materialized continuous aggregates with OI columns
--
-- PERFORMANCE IMPACT:
...
RAISE NOTICE '========================================';
RAISE NOTICE 'MIGRATION 016: CREATE CONTINUOUS AGGREGATES';
RAISE NOTICE '========================================';
RAISE NOTICE '';
RAISE NOTICE 'This will create TimescaleDB continuous aggregates';
RAISE NOTICE 'to replace the current regular views.';
RAISE NOTICE '';
...
RAISE NOTICE 'Creating fo_option_strike_bars_5min_v2 continuous aggregate...';
...
RAISE NOTICE '✅ Created fo_option_strike_bars_5min_v2';
...
RAISE NOTICE '✅ Added refresh policy for 5min aggregate';

-- ============================================================================
-- STEP 3: Create 15min Continuous Aggregate
-- ============================================================================

RAISE NOTICE 'Creating fo_option_strike_bars_15min_v2 continuous aggregate...';
...
RAISE NOTICE '✅ Created fo_option_strike_bars_15min_v2';
...
RAISE NOTICE '✅ Added refresh policy for 15min aggregate';
...
RAISE NOTICE '';
RAISE NOTICE 'Starting initial refresh (this may take a few minutes)...';
...
BEGIN
    ...
    IF count_5min > 0 AND count_15min > 0 THEN
        ...
        RAISE NOTICE 'Next step: Run migration 017 to switch to v2 aggregates.';
    ELSE
